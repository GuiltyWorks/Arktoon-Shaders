...
Shader "arktoon/Guilty/DistanceFadeTransparent" {
    Properties {
        // Double Sided
        ...
        [MaterialToggle] _FadeDepthInvert ("Invert Fade Depth", float) = 0
        // Alpha Mask
    ...
    SubShader {
        ...
        Pass {
            ...
            float _FadeStartDepth, _FadeEndDepth, _FadeDepthInvert;

            #include "cginc/arkludeFadeDecl.cginc"
            #include "cginc/arkludeOther.cginc"
            #include "cginc/arkludeVertGeom.cginc"
            #include "cginc/arkludeDistanceFadeTransparentFrag.cginc"
            ENDCG
        }
        Pass {
            Name "FORWARD_DELTA"
            ...
            #include "cginc/arkludeOther.cginc"
            #include "cginc/arkludeVertGeom.cginc"
            #include "cginc/arkludeDistanceFadeTransparentAdd.cginc"
            ENDCG
        }
        ...
        Pass {
            ...
            #include "cginc/arkludeDistanceFadeTransparentShadowCaster.cginc"
