...
Shader "arktoon/Guilty/TimeFadeTransparent" {
    Properties {
        // Double Sided
        ...
        _MainTexTime ("Main Texture Time", float) = 2
        _TexFadeTime ("Fade Time", float) = 1
        _SubTexTime ("Sub Texture Time", float) = 2
        // Alpha Mask
    ...
    SubShader {
        ...
        Pass {
            ...
            float _MainTexTime, _TexFadeTime, _SubTexTime;

            #include "cginc/arkludeFadeDecl.cginc"
            #include "cginc/arkludeOther.cginc"
            #include "cginc/arkludeVertGeom.cginc"
            #include "cginc/arkludeTimeFadeTransparentFrag.cginc"
            ENDCG
        }
        Pass {
            Name "FORWARD_DELTA"
            ...
            #include "cginc/arkludeOther.cginc"
            #include "cginc/arkludeVertGeom.cginc"
            #include "cginc/arkludeTimeFadeTransparentAdd.cginc"
            ENDCG
        }
        ...
        Pass {
            ...
            #include "cginc/arkludeTimeFadeTransparentShadowCaster.cginc"
