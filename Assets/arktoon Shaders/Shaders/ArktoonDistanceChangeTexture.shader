...
Shader "Guilty/ArktoonDistanceChangeTexture" {
    Properties {
        _SubTex ("Sub Texture", 2D) = "white" {}
        _ChangeTextureStartDepth ("Change Texture Start Depth", float) = 2
		_ChangeTextureEndDepth ("Change Texture End Depth", float) = 4
    ...
    SubShader {
        ...
        Pass {
            ...
            float _ChangeTextureStartDepth, _ChangeTextureEndDepth, _VisibilityInversion;

            #include "cginc/arkludeDistanceChangeTextureDecl.cginc"
            #include "cginc/arkludeOther.cginc"
            #include "cginc/arkludeVertGeom.cginc"
            #include "cginc/arkludeDistanceChangeTextureFrag.cginc"
            ENDCG
        }
        Pass {
            Name "FORWARD_DELTA"
            ...
            #include "cginc/arkludeOther.cginc"
            #include "cginc/arkludeVertGeom.cginc"
            #include "cginc/arkludeDistanceChangeTextureAdd.cginc"
            ENDCG
        }
        Pass {
            Name "ShadowCaster"
    ...
    FallBack "Standard"
    CustomEditor "ArktoonShaders.ArktoonDistanceChangeTextureInspector"
}
