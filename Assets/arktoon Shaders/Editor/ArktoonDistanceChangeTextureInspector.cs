...
namespace ArktoonShaders {
    public class ArktoonDistanceChangeTextureInspector : ShaderGUI {
        #region MaterialProperties
        MaterialProperty SubTexture;
        MaterialProperty ChangeTextureStartDepth;
        MaterialProperty ChangeTextureEndDepth;
        ...
        public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] props) {
            ...
            ChangeTextureStartDepth = FindProperty("_ChangeTextureStartDepth", props, false);
            ChangeTextureEndDepth = FindProperty("_ChangeTextureEndDepth", props, false);
            ...
            EditorGUI.BeginChangeCheck(); {
                // DistanceFade
                UIHelper.ShurikenHeader("Distance Change Texture");
                UIHelper.DrawWithGroup(() => {
                    ...
                    UIHelper.DrawWithGroup(() => {
                        materialEditor.ShaderProperty(ChangeTextureStartDepth, "Change Texture Start Depth");
                        materialEditor.ShaderProperty(ChangeTextureEndDepth, "Change Texture End Depth");
                    });
